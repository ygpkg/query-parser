...
function peg$parse(input, options) {
  ...
  var peg$r1 = /^[p{Any}p{L}p{N}p{P}\0-\x7F]/;
  var peg$r2 = /^[p{Z} \t\n\r]/;
  ...
  var peg$e8 = peg$classExpectation(["p", "{", "A", "n", "y", "}", "p", "{", "L", "}", "p", "{", "N", "}", "p", "{", "P", "}", ["\0", "\x7F"]], false, false);
  var peg$e9 = peg$otherExpectation("whitespace");
  var peg$e10 = peg$classExpectation(["p", "{", "Z", "}", " ", "\t", "\n", "\r"], false, false);
